...
export class HorizonNavBar extends React.Component {
                    ...
                    <ul className='navbar-nav'>
                        <li className='nav-item'>
                            <a href='/#' className='nav-link'>
                                ...
                                />
                                <div>
                                    <span className='link-text'>Bienvenido, {this.props.text}.</span>
                                    <br />
                                    <span className='link-text'>Grupo: {this.props.text}.</span>
                                </div>
                            </a>
                        </li>
